...
public class SearchController {
	...
	public Object searchHash(@Valid @RequestParam String username, @Valid @RequestParam String findContent,@Valid @RequestParam int page) {
		final BasicResponse result = new BasicResponse();
		...
		while (st.hasMoreTokens()) {
			String input = st.nextToken("#");
	         Curation tempCuration = new Curation();
	         tempCuration.setTagname(input);
	         tempCuration.setUsername(username);
	         curationDao.save(tempCuration);
		...
		System.out.println("curationlist===>"+curationList);
