    ...
    <div v-if="isDefault" class='wrap-container search-container'>
      ...
      <div class="search-box a">
        <div class="search-inner-box">
          <div @click="moreOn('a')" class="search-inner-btn">자세히</div>
          ...
          <div class="search-more-box" :class="`search-more-${1}`">
            ...
            <section class="search-more-content">
              ...
              <header class='search-more-content-head'>Content</header>
              <aside class='search-more-content-tag'>#abc #def #ghi</aside>
            </section>
      ...
      <div class="search-box b">
        <div class="search-inner-box">
          <div @click="moreOn('b')" class="search-inner-btn">자세히</div>
      ...
      <div class="search-box c">
        <div class="search-inner-box">
          <div @click="moreOn('c')" class="search-inner-btn">자세히</div>
      ...
      <div class="search-box d">
        <div class="search-inner-box">
          <div @click="moreOn('d')" class="search-inner-btn">자세히</div>
      ...
      <div class="search-box e">
        <div class="search-inner-box">
          <div @click="moreOn('e')" class="search-inner-btn">자세히</div>
          <img src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/s640x640/116473579_2695116987444102_90220358719912267_n.jpg?_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_cat=106&_nc_ohc=aHiKsGVQZWIAX8O46An&oh=69fdb8ae2cb580c65dbd10f8c6646158&oe=5F4C8B47" alt="">
        </div>
        <div class="search-inner-box">
          <div @click="moreOn('e')" class="search-inner-btn">자세히</div>
      ...
      <div class="search-box f">
        <div class="search-inner-box">
          <div @click="moreOn('f')" class="search-inner-btn">자세히</div>
          <img src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/s640x640/116473579_2695116987444102_90220358719912267_n.jpg?_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_cat=106&_nc_ohc=aHiKsGVQZWIAX8O46An&oh=69fdb8ae2cb580c65dbd10f8c6646158&oe=5F4C8B47" alt="">
        </div>
        <div class="search-inner-box">
          <div @click="moreOn('f')" class="search-inner-btn">자세히</div>
      ...
      <div class="search-box g">
        <div class="search-inner-box">
          <div @click="moreOn('g')" class="search-inner-btn">자세히</div>
          <img src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/s640x640/116473579_2695116987444102_90220358719912267_n.jpg?_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_cat=106&_nc_ohc=aHiKsGVQZWIAX8O46An&oh=69fdb8ae2cb580c65dbd10f8c6646158&oe=5F4C8B47" alt="">
        </div>
        <div class="search-inner-box">
          <div @click="moreOn('g')" class="search-inner-btn">자세히</div>
      ...
      <div class="search-box h">
        <div class="search-inner-box">
          <div @click="moreOn('h')" class="search-inner-btn">자세히</div>
          <img src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/s640x640/116473579_2695116987444102_90220358719912267_n.jpg?_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_cat=106&_nc_ohc=aHiKsGVQZWIAX8O46An&oh=69fdb8ae2cb580c65dbd10f8c6646158&oe=5F4C8B47" alt="">
        </div>
        <div class="search-inner-box">
          <div @click="moreOn('h')" class="search-inner-btn">자세히</div>
      ...
      <div class="search-box i">
        <div class="search-inner-box">
          <div @click="moreOn('i')" class="search-inner-btn">자세히</div>
          <img src="https://scontent-ssn1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/s640x640/116473579_2695116987444102_90220358719912267_n.jpg?_nc_ht=scontent-ssn1-1.cdninstagram.com&_nc_cat=106&_nc_ohc=aHiKsGVQZWIAX8O46An&oh=69fdb8ae2cb580c65dbd10f8c6646158&oe=5F4C8B47" alt="">
        </div>
        <div class="search-inner-box">
          <div @click="moreOn('i')" class="search-inner-btn">자세히</div>
...
export default {
  ...
  methods: {
    ...
    moreOn(st) {
      var a = document.querySelector(`.${st}`);
      const TEST = document.querySelector('.search-container')
      TEST.scrollTo({top:a.offsetTop, behavior:'smooth'})
    }
  },
  mounted() {
    this.goSearch()
